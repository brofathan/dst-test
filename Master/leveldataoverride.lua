return {
  ...
  custom_settings_id="CUSTOM_BISA RESPAWN + GANTI CHAR",
  custom_settings_name="bisa respawn + ganti char",
  custom_worldgen_desc="",
  custom_worldgen_id="CUSTOM_BISA RESPAWN + GANTI CHAR",
  custom_worldgen_name="bisa respawn + ganti char",
